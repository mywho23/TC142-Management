        ...
        <table id="usersTable" class="table table-bordered mt-3">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="max-width: 250px; white-space: normal; word-wrap: break-word;">{{ $r->aksi_perbaikan }}</td>
                    <td>
                    ...
                    <td>
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li>
                                    <a class="dropdown-item" href="{{ route('record.print', $r->id) }}" target="_blank">
                                        🖨 Print
                                    </a>
                                </li>

                                <li>
                                    <form action="{{ route('record.delete', $r->id) }}" method="POST">
                                        @csrf @method('DELETE')
                ...
                @empty
                <tr>
                    <td colspan="10" class="text-center">Tidak ada data Maintenance Record</td>
                </tr>
                @endforelse
            </tbody>
        </table>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="aksi_perbaikan" id="editAksiPerbaikan" class="form-control">
                            </div>
                            <div class="mb-3">
                                <label>Status</label>
                            ...
                            <div class="mb-3">
                                <label>Keyword</label>
                                <input name="keyword" id="editKeyword" class="form-control"></input>
                            </div>
                            <div class="mb-3">
                                <label>Foto Saat Ini</label><br>
                                <img id="previewOld" src="#" width="120" class="img-thumbnail mb-2" style="display:none;">
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <img id="previewNew" src="#" width="120" class="img-thumbnail mt-2" style="display:none;">
                            </div>
            ...
            document.addEventListener('DOMContentLoaded', () => {
                ...
                editButtons.forEach(btn => {
                    btn.addEventListener('click', function() {
                        ...
                        document.getElementById('editForm').action = `/record/${id}/update`;
