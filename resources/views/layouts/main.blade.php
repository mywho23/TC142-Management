            ...
            <ul class="nav">
                ...
                <li class="nav-item pt-3">
                    <a class="nav-link d-block" href="index.html">
                        <img class="sidebar-brand-logo" src="{{ asset('template/assets/images/logo.svg') }}" alt="">
                        <img class="sidebar-brand-logomini" src="{{ asset('template/assets/images/logo-mini.svg') }}" alt="">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="testview">
                ...
                <li class="pt-2 pb-1">
                    <span class="nav-item-head">INPUT</span>
                </li>
                <li class="nav-item">
                    ...
                    <div class="collapse" id="input">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"> <a class="nav-link" href="viewtable/">User</a></li>
                            ...
                            <div class="dropdown-menu dropdown-menu-left navbar-dropdown preview-list" aria-labelledby="messageDropdown">
                                ...
                                <a class="dropdown-item preview-item">
                                    <div class="preview-thumbnail">
                                        <img src="{{ asset('template/assets/images/faces/face1.jpg') }}" alt="image" class="profile-pic">
                                    </div>
                                ...
                                <a class="dropdown-item preview-item">
                                    <div class="preview-thumbnail">
                                        <img src="{{ asset('template/assets/images/faces/face6.jpg') }}" alt="image" class="profile-pic">
                                    </div>
                                    <div class="preview-item-content d-flex align-items-start flex-column justify-content-center">
                                ...
                                <a class="dropdown-item preview-item">
                                    <div class="preview-thumbnail">
                                        <img src="{{ asset('template/assets/images/faces/face7.jpg') }}" alt="image" class="profile-pic">
                                    </div>
                                    <div class="preview-item-content d-flex align-items-start flex-column justify-content-center">
                ...
                <div class="content-wrapper pb-0">
                    ...
                    <div class="row">
                        <div class="col-sm-4 stretch-card grid-margin">
                            <div class="card">
                                <div class="card-body p-0">
                                    <img class="img-fluid w-100" src="{{ asset('template/assets/images/dashboard/img_1.jpg') }}" alt="">
                                </div>
                        ...
                        <div class="col-sm-4 stretch-card grid-margin">
                            <div class="card">
                                <div class="card-body p-0">
                                    <img class="img-fluid w-100" src="{{ asset('template/assets/images/dashboard/img_2.jpg') }}" alt="">
                                </div>
                                <div class="card-body px-3 text-dark">
                                    <div class="d-flex justify-content-between">
                                        <p class="text-muted font-13 mb-0">ENTIRE APARTMENT</p>
                        ...
                        <div class="col-sm-4 stretch-card grid-margin">
                            <div class="card">
                                <div class="card-body p-0">
                                    <img class="img-fluid w-100" src="{{ asset('template/assets/images/dashboard/img_3.jpg') }}" alt="">
                                </div>
                                <div class="card-body px-3 text-dark">
                                    <div class="d-flex justify-content-between">
                                        <p class="text-muted font-13 mb-0">ENTIRE APARTMENT</p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-xl-4 stretch-card grid-margin">
                            <div class="card color-card-wrapper">
                                <div class="card-body">
                                    <img class="img-fluid card-top-img w-100" src="{{ asset('template/assets/images/dashboard/img_5.jpg') }}" alt="">
